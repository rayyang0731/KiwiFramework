...
namespace KiwiFramework.Editor
{
	...
	{
		static GraphicRaycastOutline() { SceneView.duringSceneGui += OnSceneGUI; }
		...
		[Command("Raycast Outline 开关")] public static void RaycastOutlineDisplay(bool value) { Display = value; }
	}
}