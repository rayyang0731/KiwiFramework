...
{
	public static class ContainerWindow
	{
		...
		/// </summary>
		/// <param name="instance"></param>
		public static void ToggleMaximize(object instance)
		{
			MethodInfo mInfo = ContainerWindowType.GetMethod("ToggleMaximize", BindingFlags.Public | BindingFlags.Instance);
