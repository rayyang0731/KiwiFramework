...
namespace KiwiFramework.Runtime.UI
{
	...
	[RequireComponent(typeof(RectTransform)),
	 AddComponentMenu("KiwiUI/UIElement")]
	public partial class UIElement : UIBehaviour
	{
	...
	public partial class UIElement
	{
		...
		/// 锁定字段名
		/// </summary>
		[HorizontalGroup("base/fieldName", Width = 20), HideIf(nameof(hadFieldNameLocked)),
		...
		/// 解锁字段名
		/// </summary>
		[HorizontalGroup("base/fieldName", Width = 20), ShowIf(nameof(hadFieldNameLocked)),
