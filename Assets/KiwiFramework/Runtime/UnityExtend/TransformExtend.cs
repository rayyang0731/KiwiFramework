...
namespace KiwiFramework.Runtime.UnityExtend
{
	...
	public static partial class Extend
	{
		...
		{
			if (includeInactive) return transform.GetComponentsInChildren<Transform>(true);
		...
		/// <summary>
		/// 获得 Transform 的所有子物体(递归获取)
		/// </summary>
		/// <param name="transform">被扩展的对象</param>
		/// <param name="includeInactive">是否获取未激活的子对象</param>
		/// <returns></returns>
		public static Transform[] GetChildrenRecursion(this Transform transform, bool includeInactive = false)
