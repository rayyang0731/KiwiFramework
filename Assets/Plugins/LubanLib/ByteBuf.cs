...
#pragma warning restore CA1819 // 属性不应返回数组
        ...
        public void WriteUnityVector2(Vector2 x)
        {
            WriteFloat(x.x);
            WriteFloat(x.y);
        }

        public Vector2 ReadUnityVector2()
        {
            float x = ReadFloat();
            float y = ReadFloat();
        ...
        public void WriteUnityVector3(Vector3 x)
        {
            WriteFloat(x.x);
            WriteFloat(x.y);
            WriteFloat(x.z);
        ...
        public Vector3 ReadUnityVector3()
        {
            float x = ReadFloat();
            float y = ReadFloat();
            float z = ReadFloat();
        ...
        public void WriteUnityVector4(Vector4 x)
        {
            WriteFloat(x.x);
            WriteFloat(x.y);
            WriteFloat(x.z);
        ...
        public Vector4 ReadUnityVector4()
        {
            float x = ReadFloat();
            float y = ReadFloat();
            float z = ReadFloat();
